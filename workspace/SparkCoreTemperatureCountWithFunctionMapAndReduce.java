...
import scala.Tuple2;
public class SparkCoreTemperatureCountWithFunctionMapAndReduce {
...
//		JavaRDD<String> distData = sc.textFile("/home/cloudera/dev/practice/data/data1.txt");
	...
	public static Integer computeIntegerReduceMultiply(Integer value){
		value = value * 1000;
		System.out.println("*************************************"+value);
		return value ; 
	}
