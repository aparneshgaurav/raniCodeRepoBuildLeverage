 ...
 * 1951 56
 * 
 * hadoop fs -put /home/cloudera/file.txt /user/cloudera/
 * hadoop jar Temperature.jar com.check.mapreduce.temperature.MaxTemperatureDriver /user/cloudera/file.txt output4
 * hadoop fs -cat /user/cloudera/output4/part-r-00000
 * 
