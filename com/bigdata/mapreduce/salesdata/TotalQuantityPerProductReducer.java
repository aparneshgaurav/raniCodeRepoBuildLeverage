 ...
 *
 */
public class TotalQuantityPerProductReducer extends MapReduceBase implements Reducer<Text, IntWritable
,Text, IntWritable>{
	/**
	...
	public void reduce(Text key, Iterator<IntWritable> values,
			OutputCollector<Text, IntWritable> output, Reporter reporter)
					throws IOException {
		Logger logger = Logger.getLogger(TotalQuantityPerProductReducer.class);
