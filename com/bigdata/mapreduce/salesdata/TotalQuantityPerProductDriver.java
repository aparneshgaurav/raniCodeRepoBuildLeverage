 ...
 *
 */
public class TotalQuantityPerProductDriver {
	public static void main(String[] args){
		Logger logger = Logger.getLogger(TotalQuantityPerProductDriver.class);
		logger.info("**********************execution started*****************************");
		// setting the service class.
		JobConf jobConf = new JobConf(TotalQuantityPerProductDriver.class);
		...
		jobConf.setMapperClass(TotalQuantityPerProductMapper.class);
		logger.info("*************specifying the reducer class in service ****************");
		jobConf.setReducerClass(TotalQuantityPerProductReducer.class);
